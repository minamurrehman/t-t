...
const Dlc = () => {
  return (
    <div className="max-w-7xl mx-auto my-16 ">
      {/* top bar  */}
      <div className="grid grid-cols-1 justify-items-center md:grid-cols-3 gap-6 md:justify-items-end p-4 bg-[url('/led-dlc.png')] ">
        <div className="flex flex-col gap-6 md:col-span-2 max-w-[600px] justify-self-start text-center mx-auto md:mx-0">
          ...
          <p className="text-xl md:text-3xl uppercase">
            FROM SOCIALS TO SEA, SEO, CONTENT CREATION, SALES STRATEGY TO SALES
            EXECUTION AND EFFECTIVE SALES
          </p>
        </div>
      ...
      <div className="flex flex-col-reverse md:flex-row gap-6">
        ...
        <div className="flex flex-col gap-6 w-full md:w-72 flex-shrink-0 bg-secondary p-4 md:p-2 text-black">
          ...
          <div className="flex flex-col gap-4 text-black">
            <div className="flex justify-between gap-4 items-center">
              ...
              <p>
                Total page likes increased by 150%, and post reach grew by 180%.
              </p>
            </div>
            <div className="flex justify-between gap-4 items-center">
              <p>
                Follower count surged by 200%, and reels achieved an average of
          ...
          <div>
            ...
            <p>
              ...
              clubs expressed interest in DLC SportSystems' solutions, with 50%
              of contacted clubs converting into customers
            </p>
          </div>
          <div>
            <h2 className="text-black uppercase font-bold tracking-wider">
            ...
            <p>
              ...
              optimization, led to DLC SportSystems ranking on the front page of
              Google for the highly competitive keyword "innovative sports
        ...
        <div className="my-4 flex flex-col gap-4 px-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              <span className="font-bold">Limited online visibility:</span> DLC
              SportSystems faced challenges in standing out among competitors
              due to a relatively modest online presence. <br />
              <span className="font-bold">Limited social media reach:</span>
              The company's social media channels lacked consistent and engaging
              content, resulting in limited reach and engagement. • Ineffective
              sales approach: The existing sales strategy was not reaching the
              target audience effectively, resulting in a low response rate from
              potential sports clubs.
            </p>
          </div>
          <div className="flex flex-col gap-2">
            ...
            <p className="flex flex-col gap-2">
              ...
              success stories were crafted to captivate the target audience and
              showcase DLC's expertise in the sports technology industry. <br />
              ...
              The sales strategy was designed to target sports clubs that could
              benefit from DLC SportSystems' innovative solutions. TT Marketing
              deployed personalized outreach campaigns through email marketing
              and direct messages, emphasizing the unique value proposition and
              highlighting successful case studies. By nurturing leads and
              building relationships, the team aimed to convert potential sports
              clubs into loyal customers.
            </p>
          </div>
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              content creation, and sales strategy execution has transformed DLC
              SportSystems' online presence, significantly increasing engagement
              and sales within a tight timeframe. By leveraging social media
              platforms, optimizing website content, and implementing targeted
              sales campaigns, TT Marketing successfully positioned DLC
              SportSystems as a prominent player in the sports technology
              industry, propelling them to the front page of Google for a
              high-impact keyword. The collaboration between TT Marketing and
              DLC SportSystems serves as a testament to the power of a
              comprehensive and wellexecuted digital marketing strategy in

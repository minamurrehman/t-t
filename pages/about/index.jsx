    ...
    <div className={styles.aboutWrapper}>
      <div>
        ...
        <p className={styles.aboutPara}>
          ...
          years of experience, we can guarantee working with us will be a blast!
          We’re devoted to a small number of clients and always have someone
          available to handle any social media emergencies.
        </p>
        <div>
          <span></span>
        </div>
